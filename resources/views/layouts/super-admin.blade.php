                ...
                <button 
                    ...
                    <div class="w-64 h-full overflow-hidden">
                        ...
                        <div x-show="sidebarOpen" x-transition class="p-4 flex items-center border-b h-16">
                            <h2 class="text-lg font-semibold text-gray-800">Super Admin Menu</h2>
                        </div>
                        ...
                        >
                            {{-- Super Admin specific navigation items can go here --}}
                            <a href="{{ route('super.admin.dashboard') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Dashboard</a>
                            <a href="{{ route('register', ['role' => 1]) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Create Admin</a>
                            <a href="{{ route('register', ['role' => 0]) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Create User</a>
                        </div>
                    </div>
                </div>

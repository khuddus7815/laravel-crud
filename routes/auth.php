...
// Add this route for customer logout
Route::post('customer/logout', [CustomerLoginController::class, 'destroy'])->middleware('auth:customer')->name('customer.logout');
});


// --- ORIGINAL ADMIN/DEFAULT AUTH ROUTES ---
Route::middleware('guest')->group(function () {
